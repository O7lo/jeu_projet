...
Plateau creerPlateau() {
	...
	ObjetNormal junkie("un homme cadavérique, surement un junkie", { "homme","cadavre","junkie" }, "Il ressemble vraiment à un cadavre, mais je vois son torse se soulever légèrement quand il inspire. Il a vraiment mauvaise mine, je peux voir la forme de ses os sous sa peau mince de couleur maladive. Il s'est endormi avec une bière qu'il tient encore fermement dans sa main gauche comme un enfant qui se serait endormi avec son toutou préféré. Tiens, on dirait une clef qui dépasse de sous son aisselle.","Je ne peux pas croire que je suis en train de faire ca, je voulais juste donner des cadeaux aux enfants moi!Mais cette clef peut probablement m'aider à sortir de cette maison de cauchemards. Ca pue la mort! Ce junkie ne s'est probablement pas lavé depuis des mois!Je me sens si sale maintenant que je l'ai touché! Pauvre type. J'espère qu'il ne sera pas faché que je prenne sa clef. **CLING! cling! cling.** oups! Je l'ai échappé, qu'est-ce que je suis maladroit!");
	ObjetDeplacable clef("une vieille clef en acier rouillée", {"clef","acier","rouillée"}, "C'est une clef que j'ai trouvée sous l'aisselle du junkie. Elle est rouillée et elle empeste la sueur.","Je me demande a quoi peut bien donner accès cette clef, ca avait l'air important pour ce junkie. Je vais la prendre, ca pourrait m'être utile.");
	ObjetDeplacable enfant("un enfant en piteux état, c'est un jeune garçon.", { "enfant","jeune","garçon","garcon" }, "Il a l'air terrorisé! et il est dans un état pitoyable. Son visage me rappelle celui du Junkie, ce doit être son père. L'enfant tient un toutou à l'air maléfique. Il a un air si défraichi que j'ai peur que même la laveuse ne saurait le débarrasser de la crasse dont il est recouvert. Peu importe. Je suis venu ici avec une seule mission : donner un cadeau à un enfant. J'ai justement une chose à lui offrir : de la liberté! Il faut que je trouve un moyen de le sortir de là.","Viens petit, suis moi, on va trouver un moyen de sortir d'ici et je t'emmenerai voir mon royaume au pôle-nord.");
	ObjetNormal poison("une substance douteuse, je crois que c'est du poison à rat", { "substance","poison" }, "Du poison à rat se trouve par-terre dans le laboratoire. Des rats morts jonchent le sol. On dirait un poison fait maison. OH! Il se passe ma foi des choses malsaines dans ce lieu. ","utilisation du poison");
	ObjetSerrure serrure("un trou d'une forme qui fait penser à une serrure", { "trou","serrure" }, "mais pourquoi il y aurait une serrure au fond d'un bol de toilette? C'est vraiment un endroit bizzare ici.","serrure utilisée");
	ObjetNormal bolDeToilette("le bol de toilette tout blanc", { "bol","toilette","blanc" }, "Ca \"clash\" vraiment avec le rete de la pièce, c'est la seule chose qui est propre, je me demande pourquoi.","utilisation du bol de toilette");
	...
	labo_->ajouterObjet(enfant);
	cuisine_->ajouterObjet(poison);
